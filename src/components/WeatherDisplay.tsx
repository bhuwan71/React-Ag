...
const WeatherDisplay = ({ coordinates, weatherData }: any) => {
  const weatherIcon = (weather: any) => {
    switch (weather) {
      case 'Clear':
        return <WiDaySunny className="inline-block text-4xl text-yellow-500 mr-2" />
      case 'Clouds':
        return <WiCloudy className="inline-block text-4xl text-gray-500 mr-2" />
      case 'Rain':
        return <WiRain className="inline-block text-4xl text-blue-500 mr-2" />
      case 'Snow':
        return <WiSnow className="inline-block text-4xl text-white mr-2" />
      case 'Thunderstorm':
        return <WiThunderstorm className="inline-block text-4xl text-gray-700 mr-2" />
      case 'Mist':
        return <WiFog className="inline-block text-4xl text-gray-400 mr-2" />
      default:
        return null
    }
  }
